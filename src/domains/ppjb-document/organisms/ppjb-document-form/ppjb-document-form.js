...
const propTypes = {
  ppjb_document : PropTypes.shape({
    ...
    scan_ppjb_document             : PropTypes.string
  }),
...
PpjbDocumentForm.propTypes    = propTypes
PpjbDocumentForm.defaultProps = defaultProps

export default PpjbDocumentForm