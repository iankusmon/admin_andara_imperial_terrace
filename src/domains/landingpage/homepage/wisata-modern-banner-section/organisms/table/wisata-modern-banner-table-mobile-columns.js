...
const MobileWisataModernTableColumns = ({ buttonText, buttonColour, onButtonClick }) => {
...
MobileWisataModernTableColumns.propTypes = {
  buttonText: PropTypes.string.isRequired,
  buttonColour: PropTypes.string.isRequired,
  onButtonClick: PropTypes.func.isRequired,
};

export default MobileWisataModernTableColumns;
