...
import WisataModernBannerTableColumns from './wisata-modern-banner-table-columns'; 
const propTypes = {
...
/**
 * Komponen untuk menampilkan tabel Wisata Modern Banner.
 * @param {Object} props - Properti yang diterima oleh komponen.
 */
const WisataModernTable = ({
  data,
  pagination,
  onFetchData,
  ...
  const columns = useMemo(
    () =>
      WisataModernBannerTableColumns({
        buttonText,
        buttonColour,
        onButtonClick,
      }),
...
WisataModernTable.propTypes = propTypes;
WisataModernTable.defaultProps = defaultProps;

export default WisataModernTable;
