...
const FacilityVideoShortTableColumns = ({ buttonText, buttonColour, onButtonClick }) => {
  const FacilityVideoShortStatusFilter = ({ column }) => {
  ...
  return [
    ...
    },
    {
      ...
      Filter: FacilityVideoShortStatusFilter,
...
FacilityVideoShortTableColumns.propTypes = {
  buttonText: PropTypes.string.isRequired,
  buttonColour: PropTypes.string.isRequired,
  onButtonClick: PropTypes.func.isRequired,
};

export default FacilityVideoShortTableColumns;
