...
import LandownerTableColumns from './land-owner-columns';
...
/**
 * Komponen untuk menampilkan tabel Pemilik Tanah dengan kolom spesifik.
 * @param {Object} props - Properti untuk komponen LandownerTable.
 */
const LandownerTable = ({
  data,
  pagination,
  onFetchData,
...
LandownerTable.propTypes = propTypes;
LandownerTable.defaultProps = defaultProps;
