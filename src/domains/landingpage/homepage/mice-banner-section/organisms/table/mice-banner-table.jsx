...
import MiceBannerTableColumns from './mice-banner-table-columns'; // Pastikan path sesuai
...
/**
 * Komponen untuk menampilkan tabel MICE Banner.
...
MiceTable.propTypes = propTypes;
MiceTable.defaultProps = defaultProps;
