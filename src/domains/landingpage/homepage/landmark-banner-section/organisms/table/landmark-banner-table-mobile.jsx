...
import MobileLandmarkTableColumns from './landmark-banner-table-mobile-columns'; // Pastikan path benar
...
/**
 * Komponen untuk menampilkan tabel Mobile Landmark.
 * @param {Object} props - Properti yang diterima oleh komponen.
 */
const MobileLandmarkTable = ({
  data,
  pagination,
  onFetchData,
...
MobileLandmarkTable.propTypes = propTypes;
MobileLandmarkTable.defaultProps = defaultProps;

export default MobileLandmarkTable;
