...
import MobileFacilityVideoShortTableColumns from './facility-video-short-table-mobile-columns'; // Pastikan path benar
...
/**
 * Komponen untuk menampilkan tabel Mobile Facility Video Short.
 * @param {Object} props - Properti yang diterima oleh komponen.
 */
const MobileFacilityVideoShortTable = ({
  data,
  pagination,
  onFetchData,
  ...
  const columns = useMemo(
    () =>
      MobileFacilityVideoShortTableColumns({
        buttonText,
        buttonColour,
        onButtonClick,
      }),
...
MobileFacilityVideoShortTable.propTypes = propTypes;
MobileFacilityVideoShortTable.defaultProps = defaultProps;

export default MobileFacilityVideoShortTable;
