...
const MobileAgentAffiliateTableColumns = ({ buttonText, buttonColour, onButtonClick }) => {
...
MobileAgentAffiliateTableColumns.propTypes = {
  buttonText: PropTypes.string.isRequired,
  buttonColour: PropTypes.string.isRequired,
  onButtonClick: PropTypes.func.isRequired,
};

export default MobileAgentAffiliateTableColumns;
