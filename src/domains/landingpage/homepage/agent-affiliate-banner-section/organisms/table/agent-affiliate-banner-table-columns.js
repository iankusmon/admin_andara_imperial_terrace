...
const AgentAffiliateBannerTableColumns = ({ buttonText, buttonColour, onButtonClick }) => {
  const AgentAffiliateStatusFilter = ({ column }) => {
  ...
  return [
    ...
    },
    {
      ...
      Filter: AgentAffiliateStatusFilter,
...
AgentAffiliateBannerTableColumns.propTypes = {
  buttonText: PropTypes.string.isRequired,
  buttonColour: PropTypes.string.isRequired,
  onButtonClick: PropTypes.func.isRequired,
};

export default AgentAffiliateBannerTableColumns;
