...
import DayclubBannerTableColumns from './day-club-banner-table-columns'; // Pastikan path sesuai
...
/**
 * Komponen untuk menampilkan tabel Dayclub Banner.
...
DayclubTable.propTypes = propTypes;
DayclubTable.defaultProps = defaultProps;

export default DayclubTable;
