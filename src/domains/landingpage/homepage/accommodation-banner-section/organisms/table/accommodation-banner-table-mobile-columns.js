...
const MobileAccommodationTableColumns = ({ buttonText, buttonColour, onButtonClick }) => {
...
MobileAccommodationTableColumns.propTypes = {
  buttonText: PropTypes.string.isRequired,
  buttonColour: PropTypes.string.isRequired,
  onButtonClick: PropTypes.func.isRequired,
};

export default MobileAccommodationTableColumns;
