...
const WisataModernBannerTableColumns = ({ buttonText, buttonColour, onButtonClick }) => {
  const WisataModernStatusFilter = ({ column }) => {
  ...
  return [
    ...
    },
    {
      ...
      Filter: WisataModernStatusFilter,
...
WisataModernBannerTableColumns.propTypes = {
  buttonText: PropTypes.string.isRequired,
  buttonColour: PropTypes.string.isRequired,
  onButtonClick: PropTypes.func.isRequired,
};

export default WisataModernBannerTableColumns;
