...
import AgentAffiliateBannerTableColumns from './agent-affiliate-banner-table-columns'; // Pastikan path sesuai
...
/**
 * Komponen untuk menampilkan tabel Agent Affiliate Banner.
...
const AgentAffiliateTable = ({
  ...
  const columns = useMemo(
    () =>
      AgentAffiliateBannerTableColumns({
        buttonText,
        buttonColour,
        onButtonClick,
      }),
