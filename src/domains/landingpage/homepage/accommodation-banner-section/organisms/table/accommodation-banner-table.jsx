...
import AccommodationBannerTableColumns from './accommodation-banner-table-columns'; // Pastikan path sesuai
...
/**
 * Komponen untuk menampilkan tabel Accommodation Banner.
...
const AccommodationTable = ({
  ...
  const columns = useMemo(
    () =>
      AccommodationBannerTableColumns({
        buttonText,
        buttonColour,
        onButtonClick,
      }),
...
AccommodationTable.propTypes = propTypes;
AccommodationTable.defaultProps = defaultProps;
