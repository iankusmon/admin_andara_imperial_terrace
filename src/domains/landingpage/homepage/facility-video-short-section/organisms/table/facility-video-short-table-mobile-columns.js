...
const MobileFacilityVideoShortTableColumns = ({ buttonText, buttonColour, onButtonClick }) => {
...
MobileFacilityVideoShortTableColumns.propTypes = {
  buttonText: PropTypes.string.isRequired,
  buttonColour: PropTypes.string.isRequired,
  onButtonClick: PropTypes.func.isRequired,
};

export default MobileFacilityVideoShortTableColumns;
