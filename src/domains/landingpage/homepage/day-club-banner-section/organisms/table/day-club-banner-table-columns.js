...
const DayclubBannerTableColumns = ({ buttonText, buttonColour, onButtonClick }) => {
  const DayclubStatusFilter = ({ column }) => {
...
DayclubBannerTableColumns.propTypes = {
  buttonText: PropTypes.string.isRequired,
  buttonColour: PropTypes.string.isRequired,
  onButtonClick: PropTypes.func.isRequired,
};

export default DayclubBannerTableColumns;
