...
const MiceBannerTableColumns = ({ buttonText, buttonColour, onButtonClick }) => {
  const MiceStatusFilter = ({ column }) => {
...
MiceBannerTableColumns.propTypes = {
  buttonText: PropTypes.string.isRequired,
  buttonColour: PropTypes.string.isRequired,
  onButtonClick: PropTypes.func.isRequired,
};

export default MiceBannerTableColumns;
