...
import MobileDayclubTableColumns from './day-club-banner-table-mobile-columns'; // Pastikan path benar
...
/**
 * Komponen untuk menampilkan tabel Mobile Dayclub.
 * @param {Object} props - Properti yang diterima oleh komponen.
 */
const MobileDayclubTable = ({
  data,
  pagination,
  onFetchData,
...
MobileDayclubTable.propTypes = propTypes;
MobileDayclubTable.defaultProps = defaultProps;

export default MobileDayclubTable;
