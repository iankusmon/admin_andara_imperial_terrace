...
const LandmarkBannerTableColumns = ({ buttonText, buttonColour, onButtonClick }) => {
  const LandmarkStatusFilter = ({ column }) => {
...
LandmarkBannerTableColumns.propTypes = {
  buttonText: PropTypes.string.isRequired,
  buttonColour: PropTypes.string.isRequired,
  onButtonClick: PropTypes.func.isRequired,
};

export default LandmarkBannerTableColumns;
