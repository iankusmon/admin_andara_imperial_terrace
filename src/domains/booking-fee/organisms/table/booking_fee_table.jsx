...
import bookingfeeTableColumns from './booking_fee_table_columns';
 ...
 * @param {Object} props - Properti untuk komponen BookingFeeTable.
 */
const BookingFeeTable = ({
  data,
  pagination,
  onFetchData,
...
BookingFeeTable.propTypes = propTypes;
BookingFeeTable.defaultProps = defaultProps;
