...
import FacilityVideoShortBannerTableColumns from './facility-video-short-table-columns'; // Pastikan path sesuai
...
/**
 * Komponen untuk menampilkan tabel Facility Video Short Banner.
 * @param {Object} props - Properti yang diterima oleh komponen.
 */
const FacilityVideoShortTable = ({
  data,
  pagination,
  onFetchData,
  ...
  const columns = useMemo(
    () =>
      FacilityVideoShortBannerTableColumns({
        buttonText,
        buttonColour,
        onButtonClick,
      }),
...
FacilityVideoShortTable.propTypes = propTypes;
FacilityVideoShortTable.defaultProps = defaultProps;

export default FacilityVideoShortTable;
