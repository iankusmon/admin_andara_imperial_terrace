...
const AccommodationBannerTableColumns = ({ buttonText, buttonColour, onButtonClick }) => {
  const AccommodationStatusFilter = ({ column }) => {
  ...
  return [
    ...
    },
    {
      ...
      Filter: AccommodationStatusFilter,
...
AccommodationBannerTableColumns.propTypes = {
  buttonText: PropTypes.string.isRequired,
  buttonColour: PropTypes.string.isRequired,
  onButtonClick: PropTypes.func.isRequired,
};

export default AccommodationBannerTableColumns;
