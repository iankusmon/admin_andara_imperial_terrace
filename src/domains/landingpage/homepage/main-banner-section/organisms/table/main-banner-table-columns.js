...
/**
 * Columns definition for Main Banner Table
 ...
 */
const MainBannerTableColumns = ({ buttonText, buttonColour, onButtonClick }) => {
...
MainBannerTableColumns.propTypes = propTypes;

export default MainBannerTableColumns;
