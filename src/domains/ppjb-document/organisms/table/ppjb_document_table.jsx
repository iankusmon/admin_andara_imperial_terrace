...
import ppjbdocumentTableColumns from './ppjb_document_table_columns';
 ...
 * @param {Object} props - Properti untuk komponen PpjbDocumentTable.
 */
const PpjbDocumentTable = ({
  data,
  pagination,
  onFetchData,
...
PpjbDocumentTable.defaultProps = defaultProps;
